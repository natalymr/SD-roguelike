...
def handle_player(action, game_state, previous_game_state, player, game_map, entities, colors, message_log, fov_recompute):
    player_turn_results = []
    ...
    for player_turn_result in player_turn_results:
        ...
        if item_dropped:
            ...
            game_state = GameStates.ENEMY_TURN
    return game_state, fov_recompute, player_turn_results


def loop(game_map, player, root_console, message_log, screen_width, screen_height, bar_width, panel_height, panel_y, colors,
         con, panel, entities):
    fov_algorithm = 'BASIC'
    ...
    while not tdl.event.is_window_closed():
        ...
        game_state, fov_recompute, player_turn_results = handle_player(action, game_state, previous_game_state, player,
                                                                       game_map, entities, colors, message_log, fov_recompute)
...
def main():
    ...
    loop(game_map, player, root_console, message_log, screen_width, screen_height, bar_width, panel_height, panel_y,
         colors, con, panel, entities)
